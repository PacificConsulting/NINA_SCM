page 50324 "Posted Freight Purch Invoices"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Posted Freight Purchase Invoice List';
    CardPageID = "Posted Freight Purch Invoice";
    Editable = false;
    PageType = List;
    QueryCategory = 'Posted Freight Purchase Invoices';
        ...
        area(processing)
        {
            ...
            action("Update Document")
            {
                ...
                begin
                    ...
                    //PostedPurchInvoiceUpdate.SetRec(Rec);     //PCPL-25/200223
