page 50323 "Freight Purch. Invoice Subform"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
            ...
            repeater(PurchDetailLine)
            {
                ...
                field("No."; Rec."No.")
                {
                    ...
                    begin
                        ...
                        UpdateTypeText();
                        DeltaUpdateTotals();
                        //if rec."Variant Code" = '' then   //PCPL-25/170223
                        //VariantCodeMandatory := Item.IsVariantMandatory(rec.Type = rec.Type::Item, rec."No.");    //PCPL-25/170223
                    end;
                }
                ...
                field("Variant Code"; Rec."Variant Code")
                {
                    ...
                    begin
                        DeltaUpdateTotals();
                        // if rec."Variant Code" = '' then       //PCPL-25/17223
                        //   VariantCodeMandatory := Item.IsVariantMandatory(Rec.Type = Rec.Type::Item, Rec."No.");        //PCPL-25/17223
                    end;
                }
                ...
                field(Description; Rec.Description)
                {
                    ...
                    begin
                        ...
                        //Rec.RestoreLookupSelection();       //PCPL-25/17223
                    ...
                    begin
                        //Rec.SaveLookupSelection(Selected);        //PCPL-25/170223
                    end;
                }
                ...
                field("Deferral Code"; Rec."Deferral Code")
                {
                    ...
                    begin
                        CurrPage.SaveRecord();
                        Commit();
                        //ShowDeferralSchedule();       //PCPL-25/17223
                    end;
                }
            ...
            group("&Line")
            {
                ...
                group("Related Information")
                {
                    ...
                    action(DeferralSchedule)
                    {
                        ...
                        // trigger OnAction()
                        // begin
                        //     //Rec.ShowDeferralSchedule();       //PCPL-225/170223
                        // end;
                    }
                    action(DocAttach)
                    {
