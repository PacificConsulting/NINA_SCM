page 50322 "Freight Purchase Invoice"
{
    Caption = 'Freight Purchase Invoice';
    PageType = Document;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Buy-from Contact"; Rec."Buy-from Contact")
                {
                    ...
                    // trigger OnLookup(var Text: Text): Boolean
                    // begin
                    //     //Rec.LookupBuyFromContact();       //PCPL-25/170223
                    //     CurrPage.Update();
                    // end;
                }
            ...
            part(PurchLines; "Freight Purch. Invoice Subform")
            {
                ApplicationArea = Basic, Suite;
        ...
        area(processing)
        {
            group(IncomingDocument)
            {
                ...
                action(SelectIncomingDoc)
                {
                    ...
                    //     IncomingDocument: Record "Incoming Document";
                    // begin
                    //      //Rec.Validate(Rec."Incoming Document Entry No.", IncomingDocument.SelectIncomingDocument(Rec.AddSpecialOrderToAddress();      //PCPL-25/170223
                    //     //Rec."Incoming Document Entry No.",Rec.RecordId));        //PCPL-25/170223
                    // end;
                }
                action(IncomingDocAttachFile)
                {
                    ...
                    Ellipsis = true;
                    //Enabled = (Rec."Incoming Document Entry No." = 0) AND (Rec."No." <> '');  //PCPL-25/170223
                    Image = Attach;
            ...
            group("F&unctions")
            {
                ...
                action("Create Tracking Information")
                {
                    ...
                    begin
                        //ItemTrackingDocMgt.CreateTrackingInfo(DATABASE::"Purchase Header", Rec."Document Type".AsInteger(), rec."No.");       //PCPL-25/170223
                    end;
                }
            ...
            group("P&osting")
            {
                ...
                action(RemoveFromJobQueue)
                {
                    ...
                    // trigger OnAction()
                    // begin
                    //     //rec.CancelBackgroundPosting();    //PCPL-25/170223
                    // end;
                }
            }
        }
    ...
    begin
        ...
        //if ShowConfirmCloseUnposted then  //PCPL-25/170223
        //  exit(ConfirmCloseUnposted());     //PCPL-25/170223
    end;
