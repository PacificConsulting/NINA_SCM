page 50321 "Freight Purchase Invoice List"
{
    AdditionalSearchTerms = 'vendor invoice';
    ApplicationArea = Basic, Suite;
    Caption = 'Freight Purchase Invoice List';
    CardPageID = "Freight Purchase Invoice";
            ...
            group(Action7)
            {
                ...
                action(Release)
                {
                    ...
                    begin
                        ...
                        //Rec.PerformManualRelease(PurchaseHeader);  //PCPL-25/170223
                    end;
                }
                action(Reopen)
                {
                    ...
                    begin
                        CurrPage.SetSelectionFilter(PurchaseHeader);
                        // Rec.PerformManualReopen(PurchaseHeader);      //PCPL-25/170223
                    end;
                }
            }
