page 50318 "TO (transfer issue)Machinary"
{
    Caption = 'TO (transfer issue) Machinary';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            part(TransferLines; "TO (transfer)Machinary Subform")
            {
                ApplicationArea = Location;
            ...
            group("Foreign Trade")
            {
                ...
                field("Ex work applicable"; Rec."Ex work applicable")
                {
                    ApplicationArea = All;
                }
                ...
                field("LR Applicable"; Rec."LR Applicable")
                {
                    ApplicationArea = All;
                }
                ...
                field("E-way Bill Applicable"; Rec."E-way Bill Applicable")
                {
                    ApplicationArea = All;
                }
                field("E-Way Bill No"; Rec."E-way Bill Applicable")
                {
                    ApplicationArea = All;
                }
                field("Vehicle Applicable"; Rec."Vehicle Applicable")
                {
                    ApplicationArea = All;
                }
            }
            group("Additional Transporter")
            {
                Caption = 'Additional Transporter';
                field("Add Transport Vendor No."; Rec."Add Transport Vendor No.")
                {
                    ApplicationArea = All;
                }
                field("Add Transport Vendor Desc"; Rec."Add Transport Vendor Desc")
                {
                    ApplicationArea = All;
                }
                field("Port Load"; Rec."Port Load")
                {
                    ApplicationArea = All;
                }
