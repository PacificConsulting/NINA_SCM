table 50307 "Indent Comment Line"
{
    Caption = 'Indent Comment Line';
    DrillDownPageID = "Indent Comment List";
    LookupPageID = "Indent Comment List";

    fields
    {
        field(1; "Department Type"; Enum "Indent Comment Department Type")
        {
    ...
    keys
    {
        key(Key1; "Department Type", "No.", "Document Line No.", "Line No.")
        {
            Clustered = true;
        }
    }
    ...
    var
        IndentCommentSheet: Page "Indent Comment List";
    begin
        //SetRange("Department Type", DocType);
        SetRange("No.", DocNo);
        SetRange("Document Line No.", DocLineNo);
        Clear(IndentCommentSheet);
        IndentCommentSheet.SetTableView(Rec);
        IndentCommentSheet.RunModal();
    end;
